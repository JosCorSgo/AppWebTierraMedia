...
@WebServlet("/activarTipo.do")
public class ActivarTipoServlet extends HttpServlet implements Servlet {

	private static final long serialVersionUID = -6892190410378161099L;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		tipoAtraccionService.darDeAlta(tipo);
