...
@WebServlet("/promociones/editarPorcent.do")
public class EditarPromocionPorcentlServlet extends HttpServlet implements Servlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/vistas/promociones/editarPorcent.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Producto promocion = promocionesService.actualizarPorcent(idProducto, nombre, a1, a2, descuento);
